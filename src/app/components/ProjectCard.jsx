...
import { CodeBracketIcon, EyeIcon, PlayCircleIcon } from "@heroicons/react/24/outline"
import Link from 'next/link'
import { Play } from 'next/font/google'

const ProjectCard = ({ imgUrl, title, description, gitUrl, gitUrl2, previewUrl, videoUrl }) => {
    return (
        <div>
            <div
